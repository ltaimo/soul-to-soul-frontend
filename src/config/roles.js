export const ROLE_PROFILES = {
  admin: {
    ...
    pages: ['Dashboard', 'Products', 'Inventory', 'Purchasing', 'Suppliers', 'Customers', 'Sellers & Resellers', 'Human Resources', 'Fund Requests', 'Production', 'Sales / POS', 'Reporting', 'Audit Logs', 'User Administration', 'Settings', 'Help'],
  ...
  manager: {
    ...
    pages: ['Dashboard', 'Products', 'Inventory', 'Purchasing', 'Suppliers', 'Customers', 'Sellers & Resellers', 'Human Resources', 'Fund Requests', 'Production', 'Sales / POS', 'Reporting', 'Audit Logs', 'Settings', 'Help'],
  ...
  cashier: {
    ...
    pages: ['Customers', 'Sales / POS', 'Fund Requests', 'Help'],
  ...
  salesperson: {
    ...
    pages: ['Products', 'Customers', 'Sales / POS', 'Fund Requests', 'Help'],
  ...
  stock_manager: {
    ...
    pages: ['Dashboard', 'Products', 'Inventory', 'Purchasing', 'Suppliers', 'Production', 'Fund Requests', 'Help'],
  ...
  production_manager: {
    ...
    pages: ['Products', 'Inventory', 'Production', 'Fund Requests', 'Help'],
  ...
  viewer: {
    ...
    pages: ['Dashboard', 'Products', 'Inventory', 'Customers', 'Fund Requests', 'Help'],

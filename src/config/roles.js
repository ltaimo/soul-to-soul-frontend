export const ROLE_PROFILES = {
  admin: {
    ...
    pages: ['Dashboard', 'Notifications', 'Products', 'Inventory', 'Purchasing', 'Suppliers', 'Customers', 'Sellers & Resellers', 'Quotations', 'Human Resources', 'Fund Requests', 'Production', 'Sales / POS', 'Reporting', 'Audit Logs', 'User Administration', 'Settings', 'Help'],
  ...
  manager: {
    ...
    pages: ['Dashboard', 'Notifications', 'Products', 'Inventory', 'Purchasing', 'Suppliers', 'Customers', 'Sellers & Resellers', 'Quotations', 'Human Resources', 'Fund Requests', 'Production', 'Sales / POS', 'Reporting', 'Audit Logs', 'Settings', 'Help'],
  ...
  cashier: {
    ...
    pages: ['Notifications', 'Customers', 'Quotations', 'Sales / POS', 'Fund Requests', 'Help'],
  ...
  salesperson: {
    ...
    pages: ['Notifications', 'Products', 'Customers', 'Quotations', 'Sales / POS', 'Fund Requests', 'Help'],

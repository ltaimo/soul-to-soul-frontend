export const ROLE_PROFILES = {
  admin: {
    ...
    pages: ['Dashboard', 'Products', 'Inventory', 'Purchasing', 'Suppliers', 'Customers', 'Sellers & Resellers', 'Human Resources', 'Production', 'Sales / POS', 'Reporting', 'Audit Logs', 'User Administration', 'Settings', 'Help'],
  ...
  manager: {
    ...
    pages: ['Dashboard', 'Products', 'Inventory', 'Purchasing', 'Suppliers', 'Customers', 'Sellers & Resellers', 'Human Resources', 'Production', 'Sales / POS', 'Reporting', 'Audit Logs', 'Settings', 'Help'],
  ...
  cashier: {
    ...
    pages: ['Customers', 'Sales / POS', 'Help'],
  ...
  salesperson: {
    ...
    pages: ['Products', 'Customers', 'Sales / POS', 'Help'],
  ...
  stock_manager: {
    ...
    pages: ['Dashboard', 'Products', 'Inventory', 'Purchasing', 'Suppliers', 'Production', 'Help'],
  ...
  production_manager: {
    ...
    pages: ['Products', 'Inventory', 'Production', 'Help'],
  ...
  viewer: {
    ...
    pages: ['Dashboard', 'Products', 'Inventory', 'Customers', 'Help'],
